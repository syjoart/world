(() => {
	...
	function setCanvasImages() {
		...
		for (let i = 0; i < sceneInfo[0].values.videoImageCount; i++) {
			imgElem = new Image();
			imgElem.src = `https://framebystore.cafe24.com/frameby-web/Product/01/img/006/IMG_${1001 + i}.jpg`;
		...
		for (let i = 0; i < sceneInfo[2].values.videoImageCount; i++) {
			imgElem2 = new Image();
			imgElem2.src = `https://framebystore.cafe24.com/frameby-web/Product/01/img/006/IMG_${1001 + i}.jpg`;
